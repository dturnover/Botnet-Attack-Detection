...
<h3 align="center">Botnet-Attack-Detection</h3>
  <p align="center">
...
1. Clone the repo
   ```sh
   git clone https://github.com/dturnover/Botnet-Attack-Detection-Web-App/
   ```
2. Install Conda. For instructions visit https://docs.anaconda.com/anaconda/install/windows/

3. Install pandas, sklearn and streamlit
   ```sh
   conda install pandas, sklearn and streamlit
   ```
<!-- USAGE EXAMPLES -->
## Usage
...
Web application runs using Streamlit. Open a conda terminal and run the following command:
streamlit run 
